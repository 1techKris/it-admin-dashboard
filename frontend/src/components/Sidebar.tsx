...
export default function Sidebar() {
  ...
  return (
    <div className="w-56 bg-slate-100 dark:bg-slate-800 p-4 space-y-4 h-screen overflow-y-auto">
      ...
      <div>
        <div className="text-xs font-semibold text-slate-500 dark:text-[var(--text-muted)] mb-1"Dashboard</div>
        {item("/", "Overview")}
      </div>

      <div>
        <div className="text-xs font-semibold text-slate-500 dark:text-[var(--text-muted)] mb-1"Devices & Network</div>
      ...
      <div>
        <div className="text-xs font-semibold text-slate-500 dark:text-[var(--text-muted)] mb-1"Active Directory</div>
      ...
      <div>
        <div className="text-xs font-semibold text-slate-500 dark:text-[var(--text-muted)] mb-1"VPN</div>
      ...
      <div>
        <div className="text-xs font-semibold text-slate-500 dark:text-[var(--text-muted)] mb-1"Settings</div>
